...
<template>
  <section
    class="min-h-screen flex items-center justify-center bg-linear-to-br from-blue-50 to-blue-100"
  >
    <div
      class="bg-white/80 backdrop-blur-md shadow-xl rounded-2xl p-10 w-full max-w-md border border-blue-100"
    >
